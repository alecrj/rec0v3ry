  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6">
        ...
        {trendsLoading ? (
          <div className="animate-pulse h-48 bg-zinc-800 rounded"></div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-zinc-800">
                  ...
                  <th className="text-right py-3 px-4 text-sm font-medium text-zinc-300">
                    Amount Due
                  </th>
                  <th className="text-right py-3 px-4 text-sm font-medium text-zinc-300">
                    Invoices
              ...
              <tbody>
                {delinquent?.delinquentAccounts.map((account) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-sm text-zinc-100 text-right font-medium">
