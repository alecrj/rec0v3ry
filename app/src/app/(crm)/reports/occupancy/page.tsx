  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-zinc-100">Occupancy Report</h1>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <span className="text-sm font-medium text-zinc-300 w-12">
                          {house.occupancyRate}%
                        </span>
                      </div>
                    </td>
      ...
      <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6">
        ...
        {trendsLoading ? (
          <div className="animate-pulse h-40 bg-zinc-800 rounded"></div>
        ) : (
