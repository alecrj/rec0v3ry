  ...
  return (
    <div className="p-4 space-y-6">
      <div className="bg-white rounded-lg border border-zinc-200 p-6 text-center">
        <div className="w-20 h-20 bg-[#0d9488]/15 rounded-full mx-auto flex items-center justify-center">
          <User className="h-10 w-10 text-[#0d9488]" />
        </div>
        <h1 className="text-xl font-bold text-zinc-800 mt-4">{firstName} {lastName}</h1>
        {admissionDate && (
        ...
        {isActive && (
          <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 text-green-600 rounded-full text-sm font-medium">
      ...
      <div className="space-y-2">
        ...
        <div className="bg-white rounded-lg border border-zinc-200 divide-y divide-zinc-200/50">
          <Link href="/documents" className="w-full p-4 flex items-center gap-3 hover:bg-zinc-100/40">
            <div className="w-10 h-10 bg-[#0d9488]/15 rounded-lg flex items-center justify-center">
              <Shield className="h-5 w-5 text-[#0d9488]" />
            </div>
            <div className="flex-1 text-left">
              <p className="font-medium text-zinc-800">Privacy & Consents</p>
          ...
          <Link href="/documents" className="w-full p-4 flex items-center gap-3 hover:bg-zinc-100/40">
            ...
            <div className="flex-1 text-left">
              <p className="font-medium text-zinc-800">My Documents</p>
      ...
      <button
        onClick={() => signOut()}
        className="w-full p-4 bg-white rounded-lg border border-red-500/30 flex items-center justify-center gap-2 text-red-400 hover:bg-red-500/10"
      >
