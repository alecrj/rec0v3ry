...
export default function SigningCompletePage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl shadow-xl w-full max-w-md p-8 text-center">
        {isSuccess ? (
          <>
            ...
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Document Signed!</h1>
          ...
          <>
            ...
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Document Declined</h1>
            <p className="text-zinc-400 mb-6">
          ...
          <>
            ...
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Signing Cancelled</h1>
            <p className="text-zinc-400 mb-6">
          ...
          <>
            ...
            <h1 className="text-2xl font-bold text-zinc-100 mb-2">Signing Complete</h1>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 rounded-lg font-medium text-sm transition-colors"
        >
